  ...
  const features = [
    {
      ...
      title: t("hero.features.fastDelivery.title"),
      description: t("hero.features.fastDelivery.description"),
    },
    {
      icon: <ShieldCheck className="w-6 h-6 text-green-600" />,
      title: t("hero.features.securePayment.title"),
      description: t("hero.features.securePayment.description"),
    },
    {
      icon: <Clock className="w-6 h-6 text-green-600" />,
      title: t("hero.features.easyReturns.title"),
      description: t("hero.features.easyReturns.description"),
    },
  ];

  const categories = [
    { name: t("hero.categories.newArrivals"), count: "250+" },
    { name: t("hero.categories.summerSale"), count: "150+" },
    { name: t("hero.categories.trending"), count: "100+" },
  ];
          ...
          >
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight font-poppins">
                {t("hero.mainHeading.part1")}{" "}
                <span className="text-green-600 relative">
                  {t("hero.mainHeading.part2")}
                  <svg
            ...
            <div className="relative aspect-[4/5] lg:aspect-square max-w-2xl mx-auto">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-green-600 font-semibold">
                    {t("hero.floatingElements.newArrivals")}
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-green-600 font-semibold">
                    {t("hero.floatingElements.discount")}
                  </p>
                </div>
              </motion.div>
